...
pub fn handle_event(window: &Window, event: MenuEvent) -> Result<()> {
    ...
    match event.id.0.as_str() {
        ...
        "revision_cut" => window.emit("gg://context/revision", "cut")?,
        "revision_paste_after" => window.emit("gg://context/revision", "paste_after")?,
        ...
        "revision_abandon_sub" => window.emit_to(target, "gg://context/revision", "abandon_sub_revisions")?,
